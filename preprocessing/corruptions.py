# This code is taken from https://github.com/tensorflow/datasets/blob/8e2e91bc2b817aa3ce510ea229391438dd9cb37a/tensorflow_datasets/image_classification/corruptions.py
# We modified parameters in elastic transform
...
def gaussian_noise(x, severity=1):
  ...
  #c = [.04, .08, 0.12, 0.16, 0.2][severity - 1]
  x = np.array(x) / 255.
...
def impulse_noise(x, severity=1):
  ...
  c = [.01, .03, .06, 0.09, 0.12][severity - 1]
...
def elastic_transform(x, severity=1):
  ...
  """
  c = [(244 * 0.01, 244 * 0.1, 244 * 0.01),
       (244 * 0.03, 244 * 0.3, 244 * 0.014),
       (244 * 0.05, 244 * 0.5, 244 * 0.018),
       (244 * 0.07, 244 * 0.7, 244 * 0.022),
       (244 * 0.09, 244 * 0.9, 244 * 0.026)][severity - 1]
